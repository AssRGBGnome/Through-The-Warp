...
public class Collisions16 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (death == true)
        {
            ...
            lazer4.enabled = false;
            movingplatform.enabled = false;
            eai14.Enemy_1.disable();
            eai14.Enemy_2.disable();
            eai14.Enemy_3.disable();
            eai14.Enemy_4.disable();
            eai14.Enemy_5.disable();
            eai14.Enemy_6.disable();
            eai14.Enemy_7.disable();
            eai14.Enemy_8.disable();
            eai14.Enemy_9.disable();
