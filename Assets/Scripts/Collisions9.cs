...
public class Collisions9 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (death == true)
        {
            ...
            eai8.Enemy_1.disable();
            eai8.Enemy_2.disable();
            eai8.Enemy_3.disable();
            eai8.Enemy_4.disable();
            eai8.Enemy_5.disable();
            eai8.Enemy_6.disable();
