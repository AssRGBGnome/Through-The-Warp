...
public class EnemyAI_14 : MonoBehaviour
{
    ...
    private void Start()
    {
        Enemy_1.init(Player, Enemy1, 0.034f);
        Enemy_2.init(Player, Enemy2, 0.034f);
        Enemy_3.init(Player, Enemy3, 0.034f);
        Enemy_4.init(Player, Enemy4, 0.034f);
        Enemy_5.init(Player, Enemy5, 0.034f);
        Enemy_6.init(Player, Enemy6, 0.034f);
        Enemy_7.init(Player, Enemy7, 0.034f);
        Enemy_8.init(Player, Enemy8, 0.034f);
