...
public class EnemyAI_7 : MonoBehaviour
{
    ...
    private void Start()
    {
        Enemy_1.init(Player, Enemy1, 0.046f);
        Enemy_2.init(Player, Enemy2, 0.047f);
        Enemy_3.init(Player, Enemy3, 0.046f);
        Enemy_4.init(Player, Enemy4, 0.046f);
        Enemy_5.init(Player, Enemy5, 0.046f);
        Enemy_6.init(Player, Enemy6, 0.042f);
    }
