...
public class Collisions5 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (death == true)
        {
            ...
            eai4.Enemy_1.disable();
            eai4.Enemy_2.disable();
            eai4.Enemy_3.disable();
            eai4.Enemy_4.disable();
            eai4.Enemy_5.disable();
